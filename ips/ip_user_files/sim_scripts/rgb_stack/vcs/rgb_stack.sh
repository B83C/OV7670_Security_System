...
#                script (type 'rgb_stack.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rgb_stack xil_defaultlib.glbl -o rgb_stack_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rgb_stack_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rgb_stack_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rgb_stack_simv.daidir vcs_lib c.obj)
