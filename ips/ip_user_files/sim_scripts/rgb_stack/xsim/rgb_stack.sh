...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rgb_stack xil_defaultlib.rgb_stack xil_defaultlib.glbl -log elaborate.log
}
