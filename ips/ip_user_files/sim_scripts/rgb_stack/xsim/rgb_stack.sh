...
#
# Script generated by Vivado on Sun Dec 08 09:42:50 +08 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rgb_stack.sh
...
#
# Usage        : rgb_stack.sh
#                rgb_stack.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rgb_stack.sh [-reset_run]
#                rgb_stack.sh [-reset_log]
#                rgb_stack.sh [-help]
#
...
# script info
echo -e "rgb_stack.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rgb_stack.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rgb_stack xil_defaultlib.rgb_stack xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rgb_stack -key {Behavioral:sim_1:Functional:rgb_stack} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rgb_stack.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rgb_stack.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rgb_stack.sh [-help]\n\
Usage: rgb_stack.sh [-step]\n\
Usage: rgb_stack.sh [-lib_map_path]\n\
Usage: rgb_stack.sh [-reset_run]\n\
Usage: rgb_stack.sh [-reset_log]\n\
Usage: rgb_stack.sh [-keep_index]\n\
Usage: rgb_stack.sh [-noclean_files]\n\n\
