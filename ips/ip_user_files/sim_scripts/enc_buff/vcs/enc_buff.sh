...
#
# Script generated by Vivado on Sat Dec 21 14:07:55 +08 2024
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : enc_buff.sh
...
#
# Usage        : enc_buff.sh
#                enc_buff.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                enc_buff.sh [-reset_run]
#                enc_buff.sh [-reset_log]
#                enc_buff.sh [-help]
#
...
#                script (type 'enc_buff.sh -help' for more information).
#
...
# script info
echo -e "enc_buff.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./enc_buff.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.enc_buff xil_defaultlib.glbl -o enc_buff_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./enc_buff_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key enc_buff_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc enc_buff_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./enc_buff.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: enc_buff.sh [-help]\n\
Usage: enc_buff.sh [-step]\n\
Usage: enc_buff.sh [-lib_map_path]\n\
Usage: enc_buff.sh [-reset_run]\n\
Usage: enc_buff.sh [-reset_log]\n\
Usage: enc_buff.sh [-keep_index]\n\
Usage: enc_buff.sh [-noclean_files]\n\n\
