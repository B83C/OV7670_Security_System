...
#
# Script generated by Vivado on Thu Nov 21 14:04:36 +08 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : buffer_mem.sh
...
#
# Usage        : buffer_mem.sh
#                buffer_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                buffer_mem.sh [-reset_run]
#                buffer_mem.sh [-reset_log]
#                buffer_mem.sh [-help]
#
...
# script info
echo -e "buffer_mem.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./buffer_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot buffer_mem xil_defaultlib.buffer_mem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim buffer_mem -key {Behavioral:sim_1:Functional:buffer_mem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb buffer_mem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./buffer_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: buffer_mem.sh [-help]\n\
Usage: buffer_mem.sh [-step]\n\
Usage: buffer_mem.sh [-lib_map_path]\n\
Usage: buffer_mem.sh [-reset_run]\n\
Usage: buffer_mem.sh [-reset_log]\n\
Usage: buffer_mem.sh [-keep_index]\n\
Usage: buffer_mem.sh [-noclean_files]\n\n\
