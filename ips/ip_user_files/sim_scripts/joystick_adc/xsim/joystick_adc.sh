...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot joystick_adc xil_defaultlib.joystick_adc xil_defaultlib.glbl -log elaborate.log
}
