...
#
# Script generated by Vivado on Sun Nov 24 22:43:47 +08 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : joystick_adc.sh
...
#
# Usage        : joystick_adc.sh
#                joystick_adc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                joystick_adc.sh [-reset_run]
#                joystick_adc.sh [-reset_log]
#                joystick_adc.sh [-help]
#
...
#                script (type 'joystick_adc.sh -help' for more information).
#
...
# script info
echo -e "joystick_adc.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./joystick_adc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.joystick_adc xil_defaultlib.glbl -o joystick_adc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./joystick_adc_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/b83c/fpga/vga/src/ips/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key joystick_adc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc joystick_adc_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./joystick_adc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: joystick_adc.sh [-help]\n\
Usage: joystick_adc.sh [-step]\n\
Usage: joystick_adc.sh [-lib_map_path]\n\
Usage: joystick_adc.sh [-reset_run]\n\
Usage: joystick_adc.sh [-reset_log]\n\
Usage: joystick_adc.sh [-keep_index]\n\
Usage: joystick_adc.sh [-noclean_files]\n\n\
